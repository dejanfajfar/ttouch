...
describe('ErrorHandler', () => {
	...
	describe('Given a TemplateNotFoundError and isVerbose === false', () => {
		beforeEach(() => {
			ErrorHandler(false, () => {
				throw new TemplateNotFoundError('testTemplate');
			});
		});
		it('Expect the correct info message to be printerd', () => {
			expect(console.log).to.be.calledWithMatch('Try installing it with npm install -g testTemplate');
		});
		it('Expect the correct error message to be printed', () => {
			expect(console.error).to.be.calledWithMatch('Template could not be found')
		});
	...
	describe('Given a TemplateNotFoundError and isVerbose === true', () => {
		beforeEach(() => {
			ErrorHandler(true, () => {
				throw new TemplateNotFoundError('testTemplate', new Error('Inner Error'));
			});
		});
		it('Expect the correct info message to be printerd', () => {
			expect(console.log).to.be.calledWithMatch('Try installing it with npm install -g testTemplate');
	...
	describe('Given a TemplateRenderingError and isVerbose === false', () => {
		beforeEach(() => {
			ErrorHandler(false, () => {
				throw new TemplateRenderingError('testTemplate');
			});
		});
		it('Expect the correct info message to be printerd', () => {
			expect(console.log).to.be.calledWithMatch('The file has been created but left empty');
		});
		it('Expect the correct error message to be printed', () => {
			expect(console.error).to.be.calledWithMatch('Template could not be rendered')
		});
		it('Expect that the additional error message is not printed', () => {
			expect(console.error).to.be.calledOnce;
		});
	...
	describe('Given a TemplateRenderingError and isVerbose === true', () => {
		beforeEach(() => {
			ErrorHandler(true, () => {
				throw new TemplateRenderingError('testTemplate', new Error('Inner Error'));
			});
		});
		it('Expect the correct info message to be printerd', () => {
			expect(console.log).to.be.calledWithMatch('The file has been created but left empty');
